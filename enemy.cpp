...
void initEnemy()
{
	explodese = LoadSoundMem("”š”­4.mp3");
...
void drawEnemy()
{
	...
	if (enemy[10].enable == true) {
		...
		//DrawŠÖ”‚Åã‚Æ“¯‚¶•¨‚ğd‚Ë‚é 
		SetDrawBlendMode(DX_BLENDMODE_INVSRC, 155); //”½“]‡¬ 
		//DrawŠÖ” 
		SetDrawBlendMode(DX_BLENDMODE_ADD, 155); //‰ÁZ‡¬ 

		SetDrawBlendMode(DX_BLENDMODE_INVSRC, 55); //”½“]‡¬ 
		//DrawŠÖ” 
		SetDrawBlendMode(DX_BLENDMODE_ADD, 55); //‰ÁZ‡¬ 
